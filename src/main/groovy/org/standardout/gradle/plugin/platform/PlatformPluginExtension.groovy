...
class PlatformPluginExtension {
	 ...
	 * - as String or File specifying the file location the map is persisted to / from (Json file)
	 * - a class implementing the VersionQualifierMap interface
	 */
	 ...
	 */
	String defaultQualifierMapPrefix = 'i'
	 ...
	 */
	String defaultQualifierMapFixedDatePattern
